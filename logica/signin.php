...
if($checkEmail->rowCount()==1){
    ...
    $queryInsertar=$conectar->prepare("INSERT INTO usuarios(usuario_id, usuario_email, usuario_username, usuario_clave, id_rol) VALUES (NULL,:email,:nombre,:clave,:cargo)");
    $arrayClaves=[
        ":nombre"=>$nombre,
        ":email"=>$email,
